...
import { NgClass, TitleCasePipe } from "../../../../node_modules/@angular/common";
import { PokemonService } from '../../core/services/pokemon.service';
import { getPeso, getAltura, getGeracao, embaralharString, sortearNúmeroEntre } from '../../core/utils';
import { TypePokemon } from '../../core/types/type-pokemon';
import Swal from 'sweetalert2';
@Component({
  selector: 'app-qual-pokemon',
  standalone: true,
  imports: [ContainerComponent, MatTooltipModule, FormsModule, ReactiveFormsModule, NgClass, TitleCasePipe],
...
export class QualPokemonComponent {
  ...
  pegarDadosPokemon(){
    this.pokemonImage.set(this.pokemonService.getImagePokemon(this.idPokemonSorteado))
    this.pokemonService.getPokemon(this.idPokemonSorteado).subscribe((value: any) => {
      this.pokemon = {
  ...
  submitPokemon() {
    ...
    if(this.pokemon.nome.toLocaleLowerCase() == nomePokemon.toLocaleLowerCase()){
